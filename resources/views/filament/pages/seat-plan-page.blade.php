<div>
    ...
    @if ($selectedCourse)
    <div class="seat-plan" style="display: flex; justify-content: center; width: 100%; padding-bottom: 50px; position: relative;">
        ...
        <div style="position: absolute; top: 50%; transform: translateY(-50%); right: 20px; display: flex; flex-direction: column; align-items: center; gap: 20px;">
            <div style="width: 50px; height: 80px; background-color: #ccc; display: flex; align-items: center; justify-content: center;">
                TV
            </div>
            <div style="width: 50px; height: 80px; background-color: #ccc; display: flex; align-items: center; justify-content: center; writing-mode: vertical-rl; text-orientation: upright;">
                Door
            </div>
        </div>
    </div>
